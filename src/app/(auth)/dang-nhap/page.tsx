        ...
        <div className="grid grid-cols-2 mb-6 rounded-lg bg-gray-100 p-1">
          <button
            className={`py-2 rounded-md text-sm font-medium transition ${
              tab === "admin" ? "bg-white shadow text-purple-700" : "text-gray-500"
            }`}
          ...
          <button
            className={`py-2 rounded-md text-sm font-medium transition ${
              tab === "employee" ? "bg-white shadow text-purple-700" : "text-gray-500"
            }`}
        ...
        {tab === "admin" ? (
          <form action={adminFormAction} className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-500">
              Chưa có tài khoản?{" "}
              <Link href="/dang-ky" className="text-purple-600 font-medium">
                Tạo tài khoản mới
              </Link>
            </p>
          </form>
